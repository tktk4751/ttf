...
from .signal_generator import SupertrendChopRSIShortSignalGenerator

class SupertrendChopRSIShortStrategy(BaseStrategy):
    """スーパートレンド+CHOP+RSIの売り専用戦略"""
    ...
    def __init__(
        ...
        """
        super().__init__("SupertrendChopRSIShort")
        ...
        # シグナル生成器の初期化
        self._signal_generator = SupertrendChopRSIShortSignalGenerator(
            supertrend_period=supertrend_period,
            supertrend_multiplier=supertrend_multiplier,
            chop_period=chop_period,
            chop_threshold=chop_threshold,
    ...
    def create_optimization_params(cls, trial: optuna.Trial) -> Dict[str, Any]:
        ...
        return {
            ...
            'chop_period': trial.suggest_int('chop_period', 5, 200, step=1),
            'chop_threshold':50,
