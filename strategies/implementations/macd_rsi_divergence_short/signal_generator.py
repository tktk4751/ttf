...
class MACDRSIDivergenceShortSignalGenerator(BaseSignalGenerator):
    """
    MACDダイバージェンスを使用したシグナル生成クラス（売り専用・高速化版）
    ...
    def __init__(
        ...
        """初期化"""
        super().__init__("MACDRSIDivergenceShortSignalGenerator")
    ...
    def get_exit_signals(self, data: Union[pd.DataFrame, np.ndarray], position: int, index: int = -1) -> bool:
        ...
        # キャッシュされたシグナルを使用
        # ボリンジャーバンドブレイクアウトまたはMACDダイバージェンスの買いシグナル
