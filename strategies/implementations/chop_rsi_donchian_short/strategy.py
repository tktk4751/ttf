...
from .signal_generator import ChopRSIDonchianShortSignalGenerator

class ChopRSIDonchianShortStrategy(BaseStrategy):
    """CHOP+RSI+ドンチャンの売り専用戦略"""
    ...
    def __init__(
        ...
        """
        super().__init__("ChopRSIDonchianShort")
        ...
        # シグナル生成器の初期化
        self._signal_generator = ChopRSIDonchianShortSignalGenerator(
            chop_period=chop_period,
            chop_threshold=chop_threshold,
            rsi_period=rsi_period,
            donchian_period=donchian_period,
    ...
    def create_optimization_params(cls, trial: optuna.Trial) -> Dict[str, Any]:
        ...
        return {
            ...
            'chop_threshold': 50,
            'rsi_period': trial.suggest_int('rsi_period', 5, 21, step=1),
