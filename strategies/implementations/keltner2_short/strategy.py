...
from .signal_generator import Keltner2ShortSignalGenerator


class Keltner2ShortStrategy(BaseStrategy):
    """
    ケルトナーショート戦略クラス
    ...
    def __init__(
        ...
        """初期化"""
        super().__init__("Keltner2ShortStrategy")
        ...
        # シグナル生成器の初期化
        self.signal_generator = Keltner2ShortSignalGenerator(
            entry_period=entry_period,
            entry_atr_period=entry_atr_period,
            entry_multiplier=entry_multiplier,
            exit_period=exit_period,
