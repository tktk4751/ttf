...
@jit(nopython=True)
def calculate_entry_signals(keltner: np.ndarray) -> np.ndarray:
...
class Keltner2ShortSignalGenerator(BaseSignalGenerator):
    """
    2つのケルトナーのシグナル生成クラス（売り専用・高速化版）
    ...
    def __init__(
        ...
        """初期化"""
        super().__init__("Keltner2ShortSignalGenerator")
