...
from .signal_generator import KeltnerChopShortSignalGenerator


class KeltnerChopShortStrategy(BaseStrategy):
    """
    ...
    def __init__(
        ...
        """
        super().__init__("KeltnerChopShort")
        ...
        # シグナル生成器の初期化
        self.signal_generator = KeltnerChopShortSignalGenerator(
            keltner_period=keltner_period,
            atr_period=atr_period,
            multiplier=multiplier,
            chop_period=chop_period,
