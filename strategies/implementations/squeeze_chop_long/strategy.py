...
from .signal_generator import SqueezeChopLongSignalGenerator

class SqueezeChopLongStrategy(BaseStrategy):
    """スクイーズモメンタム+チョピネスフィルターの買い専用戦略"""
    ...
    def __init__(
        ...
        """
        super().__init__("SqueezeChopLong")
        ...
        # シグナル生成器の初期化
        self._signal_generator = SqueezeChopLongSignalGenerator(
            bb_length=bb_length,
            bb_mult=bb_mult,
            kc_length=kc_length,
            kc_mult=kc_mult,
