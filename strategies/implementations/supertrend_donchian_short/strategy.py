...
from .signal_generator import SupertrendDonchianShortSignalGenerator

class SupertrendDonchianShortStrategy(BaseStrategy):
    """スーパートレンド+ドンチャンの売り専用戦略"""
    ...
    def __init__(
        ...
        """
        super().__init__("SupertrendDonchianShort")
        ...
        # シグナル生成器の初期化
        self._signal_generator = SupertrendDonchianShortSignalGenerator(
            supertrend_period=supertrend_period,
            supertrend_multiplier=supertrend_multiplier,
            donchian_period=donchian_period,
        )
