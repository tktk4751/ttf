...
from .signal_generator import AlphaChopLongShortSignalGenerator


class AlphaChopLongShortStrategy(BaseStrategy):
    """
    Alphaチャネル+チョピネスフィルター戦略（ロング・ショート両用）
    ...
    def __init__(
        ...
        """
        super().__init__("AlphaChopLongShort")
        ...
        # シグナル生成器の初期化
        self.signal_generator = AlphaChopLongShortSignalGenerator(
            kama_period=kama_period,
            kama_fast=kama_fast,
            kama_slow=kama_slow,
            atr_period=atr_period,
