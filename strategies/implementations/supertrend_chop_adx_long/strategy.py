...
from .signal_generator import SupertrendChopADXLongSignalGenerator

class SupertrendChopADXLongStrategy(BaseStrategy):
    """スーパートレンド+CHOP+ADXの買い専用戦略"""
    ...
    def __init__(
        ...
        """
        super().__init__("SupertrendChopADXLong")
        ...
        # シグナル生成器の初期化
        self._signal_generator = SupertrendChopADXLongSignalGenerator(
            supertrend_period=supertrend_period,
            supertrend_multiplier=supertrend_multiplier,
            chop_period=chop_period,
            chop_threshold=chop_threshold,
