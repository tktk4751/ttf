...
class KAMACrossChopShortSignalGenerator(BaseSignalGenerator):
    """
    KAMAクロスオーバーとチョピネスフィルターを組み合わせたシグナル生成クラス（売り専用・高速化版）
    ...
    def __init__(
        ...
        """初期化"""
        super().__init__("KAMACrossChopShortSignalGenerator")
