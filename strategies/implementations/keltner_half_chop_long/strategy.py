...
from .signal_generator import KeltnerHalfChopLongSignalGenerator


class KeltnerHalfChopLongStrategy(BaseStrategy):
    """
    ケルトナーチャネル+チョピネスフィルター戦略（買い専用）
    ...
    def __init__(
        ...
        """
        super().__init__("KeltnerHalfChopLong")
        ...
        # シグナル生成器の初期化
        self.signal_generator = KeltnerHalfChopLongSignalGenerator(
            keltner_period=keltner_period,
            atr_period=atr_period,
            multiplier=multiplier,
            chop_period=chop_period,
