...
from .signal_generator import DonchianADXShortSignalGenerator

class DonchianADXShortStrategy(BaseStrategy):
    """ドンチャン+ADX+ALMAの売り専用戦略"""
    ...
    def __init__(
        ...
        Args:
            ...
            alma_period: ALMAの期間
        """
        super().__init__("DonchianADXShort")
        ...
        # シグナル生成器の初期化
        self._signal_generator = DonchianADXShortSignalGenerator(
            donchian_period=donchian_period,
            adx_period=adx_period,
            adx_threshold=adx_threshold,
            alma_period=alma_period,
