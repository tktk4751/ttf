...
from .signal_generator import KeltnerChopLongSignalGenerator


class KeltnerChopLongStrategy(BaseStrategy):
    """
    ...
    def __init__(
        ...
        """
        super().__init__("KeltnerChopLong")
        ...
        # シグナル生成器の初期化
        self.signal_generator = KeltnerChopLongSignalGenerator(
            keltner_period=keltner_period,
            atr_period=atr_period,
            multiplier=multiplier,
            chop_period=chop_period,
