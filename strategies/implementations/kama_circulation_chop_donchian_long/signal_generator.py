...
class KAMACirculationChopDonchianLongSignalGenerator(BaseSignalGenerator):
    """
    KAMAの大循環、チョピネスフィルター、ドンチャンブレイクアウトを組み合わせたシグナル生成クラス（買い専用・高速化版）
    ...
    def __init__(
        ...
        """初期化"""
        super().__init__("KAMACirculationChopDonchianLongSignalGenerator")
