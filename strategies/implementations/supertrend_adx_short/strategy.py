...
from .signal_generator import SupertrendADXShortSignalGenerator

class SupertrendADXShortStrategy(BaseStrategy):
    """スーパートレンド+ADXフィルターの売り専用戦略"""
    ...
    def __init__(
        ...
        """
        super().__init__("SupertrendADXShort")
        ...
        # シグナル生成器の初期化
        self._signal_generator = SupertrendADXShortSignalGenerator(
            supertrend_period=supertrend_period,
            supertrend_multiplier=supertrend_multiplier,
            adx_period=adx_period,
            adx_threshold=adx_threshold,
