...
from .signal_generator import SupertrendChopROCLongSignalGenerator

class SupertrendChopROCLongStrategy(BaseStrategy):
    """スーパートレンド+CHOP+ROCの買い専用戦略"""
    ...
    def __init__(
        ...
        Args:
            ...
            roc_period: ROCの期間
        """
        super().__init__("SupertrendChopROCLong")
        ...
        # シグナル生成器の初期化
        self._signal_generator = SupertrendChopROCLongSignalGenerator(
            supertrend_period=supertrend_period,
            supertrend_multiplier=supertrend_multiplier,
            chop_period=chop_period,
            chop_threshold=chop_threshold,
