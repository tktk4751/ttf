...
class ALMATripleChopShortSignalGenerator(BaseSignalGenerator):
    """
    ALMAトリプルとチョピネスフィルターを組み合わせたシグナル生成クラス（売り専用・高速化版）
    ...
    def __init__(
        ...
        """初期化"""
        super().__init__("ALMATripleChopShortSignalGenerator")
    ...
    def get_exit_signals(self, data: Union[pd.DataFrame, np.ndarray], position: int, index: int = -1) -> bool:
        ...
        # ALMAトリプルが下降配列でない、またはチョピネスがレンジ相場
