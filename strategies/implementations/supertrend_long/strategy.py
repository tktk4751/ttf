...
from .signal_generator import SupertrendLongSignalGenerator

class SupertrendLongStrategy(BaseStrategy):
    """スーパートレンドの買い専用戦略"""
    ...
    def __init__(
        ...
        # シグナル生成器の初期化
        self._signal_generator = SupertrendLongSignalGenerator(
            supertrend_period=supertrend_period,
            supertrend_multiplier=supertrend_multiplier,
        )
