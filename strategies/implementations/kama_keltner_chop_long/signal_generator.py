...
class KAMAKeltnerChopLongSignalGenerator(BaseSignalGenerator):
    """
    KAMAケルトナーチャネル+チョピネスフィルターのシグナル生成クラス（買い専用・高速化版）
    ...
    def __init__(
        ...
        """初期化"""
        super().__init__("KAMAKeltnerChopLongSignalGenerator")
