...
from .signal_generator import ADXRSIDonchianLongSignalGenerator

class ADXRSIDonchianLongStrategy(BaseStrategy):
    """ADX+RSI+ドンチャンの買い専用戦略"""
    ...
    def __init__(
        ...
        """
        super().__init__("ADXRSIDonchianLong")
        ...
        # シグナル生成器の初期化
        self._signal_generator = ADXRSIDonchianLongSignalGenerator(
            adx_period=adx_period,
            adx_threshold=adx_threshold,
            rsi_period=rsi_period,
            rsi_upper=rsi_upper,
