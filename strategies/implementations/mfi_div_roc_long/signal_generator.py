...
class MFIDivROCLongSignalGenerator(BaseSignalGenerator):
    """
    MFIダイバージェンス+ROCのシグナル生成クラス（買い専用・高速化版）
    
    エントリー条件:
    - MFIダイバージェンスが買いシグナルを出してから13期間以内
    - ROCが買いシグナル
    ...
    def __init__(
        ...
        """初期化"""
        super().__init__("MFIDivROCLongSignalGenerator")
