...
from .signal_generator import MFIDivROCLongSignalGenerator

class MFIDivROCLongStrategy(BaseStrategy):
    """MFIダイバージェンス+ROCの買い専用戦略"""
    ...
    def __init__(
        ...
        # シグナル生成器の初期化
        self._signal_generator = MFIDivROCLongSignalGenerator(
            div_lookback=div_lookback,
            roc_period=roc_period,
            entry_mfi_period=entry_mfi_period,
            exit_mfi_period=exit_mfi_period,
