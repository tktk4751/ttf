...
from .signal_generator import KAMAKeltnerLongSignalGenerator


class KAMAKeltnerLongStrategy(BaseStrategy):
    """
    KAMAケルトナーチャネル戦略（買い専用）
    ...
    def __init__(
        ...
        """
        super().__init__("KAMAKeltnerLong")
        ...
        # シグナル生成器の初期化
        self.signal_generator = KAMAKeltnerLongSignalGenerator(
            entry_kama_period=entry_kama_period,
            entry_kama_fast=entry_kama_fast,
            entry_kama_slow=entry_kama_slow,
            entry_atr_period=entry_atr_period,
