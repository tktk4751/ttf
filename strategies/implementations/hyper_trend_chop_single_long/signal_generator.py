...
class HyperTrendChopSingleLongSignalGenerator(BaseSignalGenerator):
    """
    HyperTrend+チョピネスフィルターのシグナル生成クラス（ロング専用・高速化版）
    ...
    def __init__(
        ...
        """初期化"""
        super().__init__("HyperTrendChopSingleLongSignalGenerator")
