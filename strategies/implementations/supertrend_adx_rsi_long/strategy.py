...
from .signal_generator import SupertrendADXRSILongSignalGenerator

class SupertrendADXRSILongStrategy(BaseStrategy):
    """スーパートレンド+ADX+RSIの買い専用戦略"""
    ...
    def __init__(
        ...
        Args:
            ...
            rsi_lower: RSIの下限値
        """
        super().__init__("SupertrendADXRSILong")
        ...
        # シグナル生成器の初期化
        self._signal_generator = SupertrendADXRSILongSignalGenerator(
            supertrend_period=supertrend_period,
            supertrend_multiplier=supertrend_multiplier,
            adx_period=adx_period,
            adx_threshold=adx_threshold,
