...
class KAMAKeltnerSingleChopShortSignalGenerator(BaseSignalGenerator):
    """
    KAMAケルトナーチャネル+チョピネスフィルターのシグナル生成クラス（単一チャネル・売り専用・高速化版）
    ...
    def __init__(
        ...
        """初期化"""
        super().__init__("KAMAKeltnerSingleChopShortSignalGenerator")
