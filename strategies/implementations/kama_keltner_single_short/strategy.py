...
from .signal_generator import KAMAKeltnerSingleShortSignalGenerator


class KAMAKeltnerSingleShortStrategy(BaseStrategy):
    """
    KAMAケルトナーチャネル戦略（単一チャネル・売り専用）
    ...
    def __init__(
        ...
        """
        super().__init__("KAMAKeltnerSingleShort")
        ...
        # シグナル生成器の初期化
        self.signal_generator = KAMAKeltnerSingleShortSignalGenerator(
            kama_period=kama_period,
            kama_fast=kama_fast,
            kama_slow=kama_slow,
            atr_period=atr_period,
