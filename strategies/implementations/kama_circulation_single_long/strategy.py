...
from .signal_generator import KAMACirculationSingleLongSignalGenerator


class KAMACirculationSingleLongStrategy(BaseStrategy):
    """
    KAMAサーキュレーション戦略（単一チャネル・買い専用）
    ...
    def __init__(
        ...
        """
        super().__init__("KAMACirculationSingleLong")
        ...
        # シグナル生成器の初期化
        self.signal_generator = KAMACirculationSingleLongSignalGenerator(
            short_period=short_period,
            middle_period=middle_period,
            long_period=long_period,
            chop_period=chop_period,
