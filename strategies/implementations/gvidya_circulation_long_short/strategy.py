...
from .signal_generator import GVIDYACirculationLongShortSignalGenerator


class GVIDYACirculationLongShortStrategy(BaseStrategy):
    """
    GVIDYAサーキュレーション戦略（ロング・ショート両対応）
    ...
    def __init__(
        ...
        Args:
            short_period: 短期GVIDYAの期間
            middle_period: 中期GVIDYAの期間
            long_period: 長期GVIDYAの期間
            chop_period: チョピネスインデックスの期間
            chop_solid: チョピネスインデックスのしきい値
        """
        super().__init__("GVIDYACirculationLongShort")
        ...
        # シグナル生成器の初期化
        self.signal_generator = GVIDYACirculationLongShortSignalGenerator(
            short_period=short_period,
            middle_period=middle_period,
            long_period=long_period,
            chop_period=chop_period,
