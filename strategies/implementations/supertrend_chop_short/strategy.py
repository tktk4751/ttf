...
from .signal_generator import SupertrendChopShortSignalGenerator

class SupertrendChopShortStrategy(BaseStrategy):
    """スーパートレンド+チョピネスフィルターの売り専用戦略"""
    ...
    def __init__(
        ...
        """
        super().__init__("SupertrendChopShort")
        ...
        # シグナル生成器の初期化
        self._signal_generator = SupertrendChopShortSignalGenerator(
            supertrend_period=supertrend_period,
            supertrend_multiplier=supertrend_multiplier,
            chop_period=chop_period,
            chop_threshold=chop_threshold,
