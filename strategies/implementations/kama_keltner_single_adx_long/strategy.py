...
from .signal_generator import KAMAKeltnerSingleADXLongSignalGenerator


class KAMAKeltnerSingleADXLongStrategy(BaseStrategy):
    """
    KAMAケルトナーチャネル+ADXフィルター戦略（単一チャネル・買い専用）
    ...
    def __init__(
        ...
        """
        super().__init__("KAMAKeltnerSingleADXLong")
        ...
        # シグナル生成器の初期化
        self.signal_generator = KAMAKeltnerSingleADXLongSignalGenerator(
            kama_period=kama_period,
            kama_fast=kama_fast,
            kama_slow=kama_slow,
            atr_period=atr_period,
