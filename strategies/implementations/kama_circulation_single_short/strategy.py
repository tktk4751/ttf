...
from .signal_generator import KAMACirculationSingleShortSignalGenerator


class KAMACirculationSingleShortStrategy(BaseStrategy):
    """
    KAMAサーキュレーション戦略（単一チャネル・売り専用）
    ...
    def __init__(
        ...
        """
        super().__init__("KAMACirculationSingleShort")
        ...
        # シグナル生成器の初期化
        self.signal_generator = KAMACirculationSingleShortSignalGenerator(
            short_period=short_period,
            middle_period=middle_period,
            long_period=long_period,
            chop_period=chop_period,
