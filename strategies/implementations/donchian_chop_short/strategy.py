...
from .signal_generator import DonchianChopShortSignalGenerator


class DonchianChopShortStrategy(BaseStrategy):
    """
    ドンチャンチャネル+チョピネスフィルター戦略（売り専用）
    ...
    def __init__(
        ...
        """
        super().__init__("DonchianChopShort")
        ...
        # シグナル生成器の初期化
        self.signal_generator = DonchianChopShortSignalGenerator(
            donchian_period=donchian_period,
            chop_period=chop_period,
            chop_threshold=chop_threshold,
            rsi_period=rsi_period,
    ...
    def create_optimization_params(cls, trial: optuna.Trial) -> Dict[str, Any]:
        ...
        params = {
            ...
            'chop_threshold': 50,
            'rsi_period': trial.suggest_int('rsi_period', 5, 34, step=1),
            'rsi_exit_threshold': 14
        }
        return params
