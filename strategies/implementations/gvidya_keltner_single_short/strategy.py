...
from .signal_generator import GVIDYAKeltnerSingleShortSignalGenerator


class GVIDYAKeltnerSingleShortStrategy(BaseStrategy):
    """
    G-VIDYAケルトナーチャネル戦略（単一チャネル・売り専用）
    ...
    def __init__(
        ...
        """
        super().__init__("GVIDYAKeltnerSingleShort")
        ...
        # シグナル生成器の初期化
        self.signal_generator = GVIDYAKeltnerSingleShortSignalGenerator(
            vidya_period=vidya_period,
            sd_period=sd_period,
            gaussian_length=gaussian_length,
            gaussian_sigma=gaussian_sigma,
