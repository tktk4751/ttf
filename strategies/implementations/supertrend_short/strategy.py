...
from .signal_generator import SupertrendShortSignalGenerator

class SupertrendShortStrategy(BaseStrategy):
    """スーパートレンドの売り専用戦略"""
    ...
    def __init__(
        ...
        """
        super().__init__("SupertrendShort")
        ...
        # シグナル生成器の初期化
        self._signal_generator = SupertrendShortSignalGenerator(
            supertrend_period=supertrend_period,
            supertrend_multiplier=supertrend_multiplier,
        )
