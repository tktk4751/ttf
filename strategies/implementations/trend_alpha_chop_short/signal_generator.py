...
class TrendAlphaChopShortSignalGenerator(BaseSignalGenerator):
    """
    TrendAlpha+チョピネスフィルターのシグナル生成クラス（ショート専用・高速化版）
    ...
    def __init__(
        ...
        """初期化"""
        super().__init__("TrendAlphaChopShortSignalGenerator")
