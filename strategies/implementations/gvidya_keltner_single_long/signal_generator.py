...
class GVIDYAKeltnerSingleLongSignalGenerator(BaseSignalGenerator):
    """
    G-VIDYAケルトナーチャネルのシグナル生成クラス（単一チャネル・買い専用・高速化版）
    ...
    def __init__(
        ...
        """初期化"""
        super().__init__("GVIDYAKeltnerSingleLongSignalGenerator")
