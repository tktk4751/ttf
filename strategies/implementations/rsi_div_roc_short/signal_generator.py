...
class RSIDivROCShortSignalGenerator(BaseSignalGenerator):
    """
    RSIダイバージェンス+ROCのシグナル生成クラス（売り専用・高速化版）
    
    エントリー条件:
    - RSIダイバージェンスが売りシグナルを出してから13期間以内
    - ROCが売りシグナル
    ...
    def __init__(
        ...
        """初期化"""
        super().__init__("RSIDivROCShortSignalGenerator")
