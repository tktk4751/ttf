...
from .signal_generator import SupertrendChopRSILongSignalGenerator

class SupertrendChopRSILongStrategy(BaseStrategy):
    """スーパートレンド+CHOP+RSIの買い専用戦略"""
    ...
    def __init__(
        ...
        """
        super().__init__("SupertrendChopRSILong")
        ...
        # シグナル生成器の初期化
        self._signal_generator = SupertrendChopRSILongSignalGenerator(
            supertrend_period=supertrend_period,
            supertrend_multiplier=supertrend_multiplier,
            chop_period=chop_period,
            chop_threshold=chop_threshold,
