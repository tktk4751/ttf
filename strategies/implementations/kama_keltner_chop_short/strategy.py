...
from .signal_generator import KAMAKeltnerChopShortSignalGenerator


class KAMAKeltnerChopShortStrategy(BaseStrategy):
    """
    KAMAケルトナーチャネル+チョピネスフィルター戦略（売り専用）
    ...
    def __init__(
        ...
        """
        super().__init__("KAMAKeltnerChopShort")
        ...
        # シグナル生成器の初期化
        self.signal_generator = KAMAKeltnerChopShortSignalGenerator(
            entry_kama_period=entry_kama_period,
            entry_kama_fast=entry_kama_fast,
            entry_kama_slow=entry_kama_slow,
            entry_atr_period=entry_atr_period,
