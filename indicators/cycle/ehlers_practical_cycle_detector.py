...
from indicators.cycle.ehlers_dominant_cycle import EhlersDominantCycle, DominantCycleResult
...
class EhlersPracticalCycleDetector(EhlersDominantCycle):
    ...
    def __init__(self, min_period: float = 6.0, max_period: float = 50.0,
        ...
        # Unified Smootherの初期化（UltimateSmootherを使用）
        self.smoother = UnifiedSmoother(smoother_type='ultimate_smoother', period=smoothing_period, src_type=src_type)
