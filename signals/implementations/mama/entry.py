...
class MAMACrossoverEntrySignal(BaseSignal, IEntrySignal):
    """
    MAMA/FAMA位置関係によるエントリーシグナル
    ...
    def __init__(
        ...
        """
        super().__init__(
            f"MAMAPositionEntrySignal(fast={fast_limit}, slow={slow_limit}, {src_type})"
        )
    ...
    def generate(self, data: Union[pd.DataFrame, np.ndarray]) -> np.ndarray:
        ...
        try:
            ...
            print(f"MAMACrossoverEntrySignal計算中にエラー: {str(e)}")
